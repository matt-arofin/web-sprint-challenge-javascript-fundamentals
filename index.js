...
function summation(num) {
  ...
  return count.reduce((accumulator, next) => accumulator + next, 0);
  }
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    const displayNames = [];
    array.forEach((array) => displayNames.push(`name: ${array.animal_name}, scientific: ${array.scientific_name}`));
    return displayNames;
  }
  ...
  */
  ...
  function lowerCaseNames(array){
    const animalsLower = [];
    array.forEach((array) => animalsLower.push(array.animal_name.toLowerCase()));
    return animalsLower;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const popFilter = array.filter((array) => array.population < 5)
    return popFilter;
  }
  ...
  */
  ...
  function USApop(array){
    const total = [];
    array.forEach((element) => total.push(element.population));
